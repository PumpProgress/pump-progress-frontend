...
import 'package:pump_progress_frontend/screens/exercise/view/widgets/modal_bottom_sheet_save_exercise.dart';
...
class ExerciseSeriesItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    void updateExercise(int repetitions, double weight) {
      try {
        final exerciseBloc = context.read<SetsByExerciseBloc>();
        exerciseBloc.add(
          EditSeriesEvent(
            seriesId: series.id,
      ...
      child: Slidable(
        endActionPane: ActionPane(motion: const ScrollMotion(), children: [
          ...
          SlidableAction(
            ...
            onPressed: (context) {
              final exerciseBloc = context.read<SetsByExerciseBloc>();
              exerciseBloc.add(DeleteSeriesEvent(series.id));
            },
