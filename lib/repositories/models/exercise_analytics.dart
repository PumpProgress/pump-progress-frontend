...
class ExerciseAnalytics {
  ...
  factory ExerciseAnalytics.fromMap(Map<String, dynamic> map) {
    return ExerciseAnalytics(
  ...
  factory ExerciseAnalytics.fromJson(String source) =>
      ExerciseAnalytics.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ExerciseAnalytics(date: $date, sessionVolume: $sessionVolume, totalSets: $totalSets, totalReps: $totalReps, avgWeightPerRep: $avgWeightPerRep, maxWeight: $maxWeight, minWeight: $minWeight)';
  }

  @override
  bool operator ==(covariant ExerciseAnalytics other) {
