    ...
    return BlocConsumer<StartCalendarBloc, StartCalendarState>(
      ...
      builder: (context, state) {
        return TableCalendar(
          ...
          eventLoader: (day) {
            return state
                    .userCalendar.dates[DateFormat('yyyy-MM-dd').format(day)] ??
                [];
          },
            ...
            dowBuilder: (context, day) {
              ...
              return Center(
                child: Text(
                  text,
                  style:
                      PPFontStyles.small.copyWith(color: PPColors.neutral100),
                ),
              );
            },
              ...
              if (hasEvent(state.userCalendar.dates, day)) {
                return StartCalendarDayWidget(
                  ...
                  textColor: isSameDay(_selectedDay, day)
                      ...
                      : PPColors.coral300,
                  bgColor:
                      isSameDay(_selectedDay, day) ? PPColors.coral300 : null,
                );
              } else {
                return null;
              }
            },
            todayBuilder: (context, day, focusedDay) => StartCalendarDayWidget(
              day: day,
