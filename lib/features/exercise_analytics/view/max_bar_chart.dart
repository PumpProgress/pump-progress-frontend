...
class MaxWeightBarChart extends StatelessWidget {
  final List<ExerciseAnalytics> rawData;

  const MaxWeightBarChart({super.key, required this.rawData});
